...
## 日程约束（IEEE SaTML 2027）

摘要 **2026-09-22** · 投稿 **2026-09-29** · 早期拒稿 11-04 · 通知 12-16 ·
**修订截止 2027-01-21**（约五周窗口）。全部 AoE。

写作排期上倒推：格式转换（USENIX → IEEE 双栏）与写作占末尾约 5 天，实验须 **9/24** 前落地。

## 待确认

- [ ] SaTML 的页数上限（官网未列；决定理论下沉到附录的比例）—— 投稿前需从 CFP 确认
